...
and install the software. Do not attempt to install from the Microsoft store. Docker will  ask you to restart your PC to complete installation.  If you are installing remotely on the UQ Labs, please wait a few minutes for the machine to reboot.  If you log straight in, you'll likely be allocated another machine from the lab pool.
